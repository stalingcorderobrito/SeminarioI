...
\title{\textbf{GUÍA PARA ELABORAR EL PROYECTO DE INVESTIGACIÓN CIENTÍFICA}}
\author{Mtro. Staling Cordero Brito \\ scordero48@uasd.edu.do \\ \href{https://scholar.google.com/citations?user=qJyINo0AAAAJ}{Google Scholar}}
\date{\today}
...
\noindent
Facilitan una rápida identificación de los temas centrales del trabajo. Se se recomienda redactar un título preliminar del
estudio· y seleccionar las dos o
tres palabras que capten la idea
central.
...
\noindent
Esta sección implica un proceso de inmersión en el
conocimiento existente y disponible que debe estar relacionado con el planteamiento del problema
(objetivos, preguntas, justificación, viabilidad y evaluación de las deficiencias de lo que se sabe del
problema), y a su vez, con los métodos, técnicas y materiales utilizados en
estudios anteriores, que sustenten los métodos que se van a aplicar en su proyecto
de estudio de investigación. Se deben agregar las citas bibliográficas empleadas Se recomienda utilizar los artículos con no más de 5 a 10 años (aunque no es limitativo) que se
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 13. Presupuesto (en Pesos Dominicanos)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\section{Formato para la elaboración de la investigación: Reglamento de Posgrado de la Universidad Autónoma de Santo Domingo (UASD)}
